...
def count_objects_in_video(video_file_path: str, output_video_path: str) -> dict:
    ...
    count_feeder_mites = math.ceil(len(unique_ids_feeder_mites) * tracker1)
...
if __name__ == "__main__":
    print(count_objects_in_video(video_file_path="C:\\Users\\kingh\\Downloads\\1.mp4", output_video_path="output_video.mp4"))